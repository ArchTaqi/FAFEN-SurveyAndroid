package com.sourcey.survey.FormSeven;
...
import com.sourcey.survey.Fragments.TrueFalseFragment;
...
public class FormSeven extends AppCompatActivity  implements TrueFalseInterface
{
...
//                            Toast.makeText(FormSeven.this, "unable to get current location", Toast.LENGTH_SHORT).show();
    ...
    @Override
    public void callFromFragment(boolean isQuestionAsnwered, String ans) {
        if(currentPage == 3) {
            ans4 = ans;
            questionFourAsnwered = isQuestionAsnwered;
            nextButton.performClick();

        }else if(currentPage == 4){
            ans5 = ans;
            questionFiveAsnwered = isQuestionAsnwered;
            nextButton.performClick();
        }
    }

    @Override
    public void onErrorValidation(boolean questionThreeAsnwered) {
    ...
    public class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                ...
                case 3:
                    String titleMessage = "Is the Results Transmission System (RTS) installed on the Presiding Officer's mobile phone?  \n کیا پریزائیڈنگ افسر کو موبائل فون میں ریزلٹ ٹرانسمیشن سسٹم (RTS) ایپ انسٹال کر کے دی گئی ہے؟";
                    pagerNumber = position+1  + " of " + NUMBER_OF_PAGES;


                    return TrueFalseFragment.newInstance(5, Color.CYAN,
                        FormSeven.this,questionFourAsnwered,ans4,titleMessage,pagerNumber );
                case 4:
                    String titleMessage4 = "Did the Presiding Officer receive RTS training?  \n کیا پریزائیڈنگ افسر کو موبائل فون میں ریزلٹ ٹرانسمیشن سسٹم (RTS) ایپ کے استعمال کی تربیت فراہم کی گئی ہے؟";
                    pagerNumber = position+1  + " of " + NUMBER_OF_PAGES;


                    return TrueFalseFragment.newInstance(5, Color.CYAN,
                        FormSeven.this,questionFiveAsnwered,ans5,titleMessage4,pagerNumber );
                case 5:
