package com.sourcey.survey.FormTwelve;
...
public class FormTwelve extends AppCompatActivity  implements TimerInterface
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
      ...
      sharedPreferences  = getApplicationContext().getSharedPreferences("USER_ID",MODE_PRIVATE);
        ...
        doneButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                if (!questionThirteenAnswerd && currentPage == 12)
                {
...
//                            Toast.makeText(FormTwelve.this, "unable to get current location", Toast.LENGTH_SHORT).show();
        ...
        nextButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    if(exceedsTimeLimit){
                        HelperClass.showDialog(FormTwelve.this, "Please select the time between 8am to 8pm");
                    }else {
                        HelperClass.showDialog(FormTwelve.this, "Empty Field");
                    }
                    return;
                }
    ...
    @Override
    public void callFromFragment(boolean questionThreeAsnweredx, String ans3x, boolean exceedsTimeLimits) {
        ans6 = ans3x;
        questionSixAnswerd = questionThreeAsnweredx;
        exceedsTimeLimit = exceedsTimeLimits;
    }

    @Override
    public void onErrorValidation(boolean questionThreeAsnweredx, boolean exceedsTimeLimits) {
        questionSixAnswerd = questionThreeAsnweredx;
        exceedsTimeLimit = exceedsTimeLimits;
    }
...
//                    return FormTwelve.FragmentSix.newInstance(5, Color.CYAN);
                ...
                fragment.newInstance(5, Color.CYAN );
                fragment.setMediator(FormTwelve.this,pagerNumber);
                return fragment;
                case 6:
