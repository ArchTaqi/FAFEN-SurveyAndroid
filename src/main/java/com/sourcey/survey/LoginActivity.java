...
public class LoginActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        AlreadyLogin = sharedPreferences.getBoolean("AlreadyLogin", AlreadyLogin);
...
//            String ServerURL = "http://alahbabgroup.com/survey/Phone-Web-PHP/checkuser.php" ;
            String ServerURL = "http://www.emis.creativecube.io/Servey-PHP/checkuser.php";
                try {
                    publishProgress();
        ...
        {     //alertDialog.setMessage(result);
            if(strResult.size()>0)
            {
                ...
                {
                    id = Integer.parseInt(strResult.get(1));
...
//                            .getDefaultSharedPreferences(LoginActivity.this);
                    ...
                    sharedPreferences.edit().putBoolean("AlreadyLogin",true).apply();
