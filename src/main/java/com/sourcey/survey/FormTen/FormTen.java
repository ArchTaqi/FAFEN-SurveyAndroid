package com.sourcey.survey.FormTen;
...
public class FormTen extends AppCompatActivity
{
    ...
    com.sourcey.survey.FormTen.FormTen.MyAdapter mAdapter;
    ViewPager mPager;
    int currentPage = 0;
    static int s1,s2;
  ...
  Button backButton;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mAdapter = new com.sourcey.survey.FormTen.FormTen.MyAdapter(getSupportFragmentManager());
        ...
        mFusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(com.sourcey.survey.FormTen.FormTen.this);
        doneButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                if (!FormTen.FragmentEight.isAnswered()&& currentPage == 7)
                {
...
//                            Toast.makeText(com.sourcey.survey.FormTen.FormTen.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                ...
                Toast.makeText(com.sourcey.survey.FormTen.FormTen.this, "Done", Toast.LENGTH_LONG).show();
                finish();
    ...
    public static class MyAdapter extends FragmentPagerAdapter
    {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    return com.sourcey.survey.FormTen.FormTen.FragmentOne.newInstance(0, Color.WHITE);
                case 1:
                    return com.sourcey.survey.FormTen.FormTen.FragmentTwo.newInstance(1, Color.CYAN);
                case 4:
                    return com.sourcey.survey.FormTen.FormTen.FragmentThree.newInstance(4, Color.CYAN);
                case 3:
                    return com.sourcey.survey.FormTen.FormTen.FragmentFour.newInstance(3, Color.CYAN);
                case 2:
                    return com.sourcey.survey.FormTen.FormTen.FragmentFive.newInstance(2, Color.CYAN);
                case 5:
                    return com.sourcey.survey.FormTen.FormTen.FragmentSix.newInstance(5, Color.CYAN);
                case 6:
                    return com.sourcey.survey.FormTen.FormTen.FragmentSeven.newInstance(6, Color.CYAN);
                case 7:
                    return com.sourcey.survey.FormTen.FormTen.FragmentEight.newInstance(7, Color.CYAN);
                default:
                    return null;
            }
        }
    ...
    public static class FragmentOne extends Fragment
    {
        ...
        static com.sourcey.survey.FormTen.FormTen.FragmentOne newInstance(int num, int color)
        {
            com.sourcey.survey.FormTen.FormTen.FragmentOne f = new com.sourcey.survey.FormTen.FormTen.FragmentOne();
            return f;
        }
            ...
            editText.addTextChangedListener(new TextWatcher()
            {
                ...
                public void onTextChanged(CharSequence s, int start, int before, int count)
                {
                    if (!editText.getText().toString().isEmpty())
                        com.sourcey.survey.FormTen.FormTen.questionOneAsnwered = true;
                    else
                        com.sourcey.survey.FormTen.FormTen.questionOneAsnwered = false;
                }
    ...
    public static class FragmentTwo extends Fragment implements View.OnClickListener
    {
        ...
        // You can modify the parameters to pass in whatever you want
        static com.sourcey.survey.FormTen.FormTen.FragmentTwo newInstance(int num, int color)
        {
            com.sourcey.survey.FormTen.FormTen.FragmentTwo f = new com.sourcey.survey.FormTen.FormTen.FragmentTwo();
        ...
        public void onClick(View v)
        {
            com.sourcey.survey.FormTen.FormTen.questionTwoAsnwered = true;
    ...
    public static class FragmentThree extends Fragment
    {
        ...
        public void setUserVisibleHint(boolean isVisibleToUser)
        {
            ...
            if (this.isVisible())
            {
                com.sourcey.survey.FormTen.FormTen.questionThreeAsnwered = true;
        ...
        // You can modify the parameters to pass in whatever you want
        static com.sourcey.survey.FormTen.FormTen.FragmentThree newInstance(int num, int color)
        {
            com.sourcey.survey.FormTen.FormTen.FragmentThree f = new com.sourcey.survey.FormTen.FormTen.FragmentThree();
            return f;
        }
    ...
    public static class FragmentFour extends Fragment
    {
        ...
        // You can modify the parameters to pass in whatever you want
        static com.sourcey.survey.FormTen.FormTen.FragmentFour newInstance(int num, int color)
        {
            com.sourcey.survey.FormTen.FormTen.FragmentFour f = new com.sourcey.survey.FormTen.FormTen.FragmentFour();
            return f;
        }
    ...
    public static class FragmentFive extends Fragment
    {
        ...
        // You can modify the parameters to pass in whatever you want
        static com.sourcey.survey.FormTen.FormTen.FragmentFive newInstance(int num, int color)
        {
            com.sourcey.survey.FormTen.FormTen.FragmentFive f = new com.sourcey.survey.FormTen.FormTen.FragmentFive();
            return f;
        }
                                 ...
                                 Bundle savedInstanceState)
        {
            ...
            editText.addTextChangedListener(new TextWatcher()
            {
                ...
                public void onTextChanged(CharSequence s, int start, int before, int count)
                {
                    if (!editText.getText().toString().isEmpty())
                    {
                        com.sourcey.survey.FormTen.FormTen.questionFiveAnswerd = true;
                      /*  s1 = editText.getText().toString();*/
                    }
                    else
                        com.sourcey.survey.FormTen.FormTen.questionFiveAnswerd = false;
                }
